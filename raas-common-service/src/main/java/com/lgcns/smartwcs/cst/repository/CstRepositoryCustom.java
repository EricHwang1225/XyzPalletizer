 ...
 * @version $Id$
 */
public interface CstRepositoryCustom {

    Page<Cst> findAllBySearch(CstSearchCondition condition, Pageable pageable);
    List<Cst> findAllBySearch(CstSearchCondition condition);
}
