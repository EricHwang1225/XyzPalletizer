 ...
 * @version $id$
 */
package com.lgcns.smartwcs.tenant_menu.repository;
...
public interface TenantMenuMapper {
    ...
    List<Menu> getTenantMenuTreeList(TenantSearchCondition tenantSearchCondition);

    void saveTenantMenu(TenantMenu tenantMenu);
}
