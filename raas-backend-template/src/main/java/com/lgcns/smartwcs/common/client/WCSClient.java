...
public class WCSClient {
    ...
    private final String requestUrl = "http://localhost:8090/interface/";

    public static final String REQUEST_INBOUND = "requestInbound";
    public static final String CANCEL_INBOUND = "requestInboundCancellation";
    public static final String REQUEST_OUTBOUND = "requestOutbound";
    public static final String CANCEL_OUTBOUND = "requestOutboundCancellation";
    public static final String REQUEST_INV_ADJUSTMENT = "requestStockQuantityAdjustment";
    public static final String REQUEST_STOCKTAKING = "requestStocktaking/oneToOne";
    public static final String CANCLE_STOCKTAKING = "requestStocktakingCancellation";
    public static final String SEND_BIN_MASTER = "sendBinMasterInfo";
    public static final String SEND_BIN_MASTER_RANGE = "sendBinMasterInfo/range";
